...

{
  !authStatus? (<div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-2 sm:before:flex-1">
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#caa583] to-[#9089fc] opacity-30"
          style={{
            clipPath:
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <Link onClick={()=>setloading2(true)} href="/register"> {/* Replace with your login route */}
                    <div className="flex-none rounded-full bg-mycolor px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900
       ">
    ...
    <Disclosure as="nav" className="xl:text-gray-700 p-2 sticky top-0 z-50 bg-white shadow-lg absolute inset-0 bg-white   ">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 w-full sm:px-6 lg:px-8   ">
            <div className="relative flex h-16 items-start justify-between">
              <div className="left-0  flex items-center sm:hidden">
                {/* Mobile menu button */}
                <Disclosure.Button className="relative inline-flex items-start justify-center rounded-md p-2 text-gray-400 hover:bg-mycolor hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <div className="absolute inset-y-0 z-10 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {status ? (
                    ...
                    {myUser ? (
                      <>
                        <Menu as="div" className="relative ml-3 z-10">
                          <div>
                            <Menu.Button className="relative flex rounded-full bg-mycolor text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <Link onClick={()=>setloading(true)} href="/login"> {/* Replace with your login route */}
                    <div className="m-5 rounded-md flex text-white bg-mycolor  px-3.5 py-2.5 text-sm font-semibold shadow-sm focus:outline-visible focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
