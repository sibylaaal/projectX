...
export default function Artical() {
  return (
    ...
    <div
    id="features"
    className="relative w-full px-8 py-5 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0"
  >
      ...
      <div className="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
        <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
          <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
            ...
            <h4 className="relative mt-6 text-lg font-bold">Building Documents</h4>
            <p className="relative mt-2 text-base text-center text-gray-600">
              Build your Document with these top of the line marketing tools.
            </p>
        ...
        <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
          <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
            ...
            <h4 className="relative mt-6 text-lg font-bold">SmartDocs</h4>
            <p className="relative mt-2 text-base text-center text-gray-600">
              SmartDocs are making it different
            </p>
