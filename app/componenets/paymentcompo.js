...
export default function Payment(){
 ...
 const Toggle=()=>{
  ...
  <div className="container max-w-screen-lg mx-auto">
    <div>
      <h2 className="font-semibold text-xl text-gray-600">Payment Form</h2>
      <p className="text-gray-500 mb-6">
     Simple,Safe,Fast Payment.
      </p>
      <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
      <label for="toggle-example" class="flex items-center cursor-pointer relative mb-4">
    <input onChange={()=>Toggle()} type="checkbox" id="toggle-example" class="sr-only"/>
    <div class="toggle-bg bg-gray-200 border-2 border-gray-200 h-6 w-11 rounded-full"></div>
    <span class="ml-3 text-gray-900 text-sm font-medium"><img className="h-5 w-5" src={"/paypall.png"}/></span>
    </label>
