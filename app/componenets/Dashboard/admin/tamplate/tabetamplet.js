                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to Delete your Template? All of your documents related with this template will be permanently
                        ...
                        <div className="py-1">
                          <Menu.Item className="hover2">
                            {({ active }) => (
                              ...
                              >
                                <div onClick={() => setOpen(true)} className='flex align-center'>
